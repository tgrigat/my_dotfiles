...
local mappings = {
    ["<leader>P"] = { "<cmd>Legendary commands<cr>", "Command palette" },
    ['<leader>p'] = { "<cmd>Telescope commands<cr>", "Command palette" },
    ...
    ["<leader>="] = {
        ...
        s = { "<cmd>source ~/.config/nvim/init.lua<cr>", "Source Setting" },
